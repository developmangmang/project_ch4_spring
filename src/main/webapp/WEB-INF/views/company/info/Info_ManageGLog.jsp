...
<title>반입현황 관리 - CH4 방문/반입 자동화 시스템</title>
<!-- 공통코드 -->
						...
						<tr>
	                		<td>
	        					<select class="easyui-combobox" id="SearchType" name='SearchType'
									label="검색조건" labelPosition="top" 
									style="width: 95%;" data-options="panelHeight:'auto'">
									<option value="confm_no" selected>물품번호</option>
									<option value="confm_name">물품명</option>
									<option value="confm_desti">방문장소</option>
								</select>
	                		</td>
	                	</tr>
	                	<tr id="line">
	                	...
	                	<tr id="line">
	                		<td>
	                			<select class="easyui-combobox" id="state" name="confm_state"
									label="반입현황" labelPosition="top" style="width: 95%;"
	                	...
	                	<tr id="line">
	                		<td>
	                			<select class="easyui-combobox" id="time" name="confm_trans_time"
									label="반입시간" labelPosition="top" style="width: 95%;"
									data-options="panelHeight:'auto'">
									<option value="" selected>전체</option>
