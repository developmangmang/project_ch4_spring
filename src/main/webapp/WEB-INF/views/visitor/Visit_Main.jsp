					...
					<div id="form1" class="col-lg-6">
						...
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-lg-4">
										<img class="img-circle" src="http://localhost:8000/resources/Style/images/crud/buildings.png">
									</div>
									<div class="col-lg-8">
										<br>
					...
					<div id="form1" class="col-lg-6">
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-lg-4">
										<img class="img-circle" src="http://localhost:8000/resources/Style/images/crud/clipboard.png">
									</div>
				...
				<div id="form1" class="col-lg-12">
					<div class="panel panel-info">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-2">
									<img class="img-circle" src="http://localhost:8000/resources/Style/images/crud/searchbox.png" style="background-color:#6EAFA8">
								</div>
								...
								<div class="col-lg-6" style="padding-left:0px;padding-right:0px;text-align:center;">
									...
									<img id="img_process" src="/resources/Style/images/crud/img_process.png">
								</div>
							</div>
						</div>
					</div>
