...
<body>
   ...
   //오시는길
   function navigation(){   
      $("#form_navi").attr('action','/goods/navigation.ch4');
      $("#form_navi").submit();
   }
   //반입신청 취소
		...
		<div class="row">
			<div class="col-lg-8 col-lg-offset-2">
				<div style="text-align: center;">
					<img
						src="${host}/resources/Style/images/crud/transport_logo_default.png"
						class="img-thumbnail" style="width: 30%; border: 0px;">
					<h3 style="margin-top: 10px;">
						"고객님의 반입신청이 <b style="font-size: 40px; color: #b22222;">접수</b><b
							style="font-size: 24px; color: #4169e1;">(<%=aplg_no %>)
						</b>되었습니다."
					</h3>
				</div>
				<br>
